            ...
            if ($model2->review_id) {
                ...
                if ($reviewDetails) {
                    foreach ($reviewDetails as $reviewDetail) {
                        ...
                        if (empty($reviewDetail2->title)) {
                            $reviewDetail2->title = 'N/A';
                        }
                ...
                if ($reviewStores) {
                    foreach ($reviewStores as $reviewStore) {
                        ...
                        $reviewStore2->store_id = isset($mappingStores[$reviewStore->store_id]) ? $mappingStores[$reviewStore->store_id] : 0;
                ...
                if ($mg1Version != 'mage16x') {
                    ...
                    if ($ruleCustomerGroups) {
                        foreach ($ruleCustomerGroups as $ruleCustomerGroup) {
                            ...
                            $ruleCustomerGroup2->customer_group_id = isset($mappingCustomerGroups[$ruleCustomerGroup->customer_group_id]) ? $mappingCustomerGroups[$ruleCustomerGroup->customer_group_id] : 0;
